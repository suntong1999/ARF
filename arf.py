...
class InvertedResidual_Arf(nn.Module):
    def __init__(
        self,
        inp: int,
        oup: int,
        ...
        super(InvertedResidual_Arf, self).__init__()
        self.stride = stride
        assert stride in [1, 2]
        ...
        # gcc
        self.gcc_H = Arf_operator(hidden_dim//2, 'H', global_kernel_size, use_pe)
        self.gcc_W = Arf_operator(hidden_dim//2, 'W', global_kernel_size, use_pe)
...
class Arf_MobileNetV1(nn.Module):
    def __init__(
        self,
        in_chans: int = 3,
        drop_path_rate=0.,
        ...
        """
        super(Arf_MobileNetV1, self).__init__()
        ...
        for t, c, n, s, gcc, r in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                if i < gcc:
                    ...
                    features.append(InvertedResidual_Arf(input_channel, output_channel, stride, expand_ratio=t,
...
@register_model
def Arf_mv1(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> Arf_MobileNetV1:
    """
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = Arf_MobileNetV1(**kwargs)
    # test
